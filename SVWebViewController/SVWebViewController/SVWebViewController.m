...
@synthesize urlString, showsDoneButton, tintColor;
...
- (void)tintNavBar {
    ...
    [backButton setBackgroundImage:[UIImage imageNamed:@"sv-back-white.png"] forState:UIControlStateNormal];
    [forwardButton setBackgroundImage:[UIImage imageNamed:@"sv-forward-white.png"] forState:UIControlStateNormal];
    [actionButton setBackgroundImage:[UIImage imageNamed:@"sv-action-white.png"] forState:UIControlStateNormal];
}
...
- (void)viewDidLoad {
	...
	if(!deviceIsTablet) {
        ...
        // Replace images with our custom white ones.
        [self tintNavBar];
...
- (void)setupTabletToolbar {
	...
	if(self.webView.loading && !stoppedLoading) {
        ...
        if (tintColor)
            [refreshStopButton setBackgroundImage:[UIImage imageNamed:@"sv-stop-white.png"] forState:UIControlStateNormal];
        else
        ...
        if (tintColor)
            [refreshStopButton setBackgroundImage:[UIImage imageNamed:@"sv-refresh-white.png"] forState:UIControlStateNormal];
        else
            [refreshStopButton setBackgroundImage:[UIImage imageNamed:@"SVWebViewController.bundle/iPad/refresh"] forState:UIControlStateNormal];
	}
}
